...
<body>
	...
	<form:form method="post" action="/registro" class="container my-5 w-50 bg-warning border border-warning rounded" modelAttribute="libro">
		...
		<div class="mb-3">
			<form:label for="titulo" path="titulo" class="form-label mt-3 text-light fw-bold">INGRESE NOMBRE DE LIBRO</form:label> 
			<form:input type="text" class="form-control" id="titulo" path="titulo"/>
		</div>
		
		<div class="mb-3">
			<form:label for="anio" path="anio" class="form-label text-light fw-bold">AÑO DE PUBLICACIÓN</form:label> 
		...
		<div class="mb-3">
			<form:label for="imprenta" path="imprenta" class="form-label text-light fw-bold">IMPRENTA</form:label> 
		...
		<form:select id="disponible" name="disponible" path="disponible" class="form-select text-success fw-bold">
			<form:option value="">INGRESE DISPONIBILIDAD</form:option>
				<form:option  value="1">Disponible</form:option>
				<form:option value="0">No Disponible</form:option>
		</form:select>
		</div>
		<button type="submit" class="btn btn-success fw-bold my-3">AÑADIR LIBRO</button>
	</form:form>
